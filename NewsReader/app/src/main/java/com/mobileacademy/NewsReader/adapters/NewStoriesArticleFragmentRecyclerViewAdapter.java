 ...
 * specified
 */
public class NewStoriesArticleFragmentRecyclerViewAdapter extends RecyclerView.Adapter<NewStoriesArticleFragmentRecyclerViewAdapter.ViewHolder> {

    private ArrayList<Article> mValues;
    private final NewStoriesArticleFragment.OnListFragmentInteractionListener mListener;

    public NewStoriesArticleFragmentRecyclerViewAdapter(ArrayList<Article> items, NewStoriesArticleFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onNewStoryArticleSelected(holder.mItem);
                }
            }
        });
    }
